 ...
 * @property int $create_at Час створення
 * @property int $update_at Час останнього оновлення
...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['age'], 'safe'],
            [['type_zp', 'id_group', 'status', 'create_at', 'update_at'], 'integer'],
            [['zp_h'], 'number'],
            [['phone'], 'string', 'max' => 13],
            [['role'], 'string', 'max' => 16],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'update_at' => 'Час останнього оновлення',
            'f_name' => 'Ім\'я',
            'l_name' => 'Фамілія',
            'age' => 'Дата народження',
            'position' => 'Посада',
